 ...
 */
package org.apache.openejb.jee.jboss;
...
public class JaxbJboss {
    ...
    public static <T> Object unmarshal(final Class<T> type, final InputStream in, final boolean logErrors) throws ParserConfigurationException, SAXException, JAXBException {
        ...
        final JbossNamespaceFilter xmlFilter = new JbossNamespaceFilter(parser.getXMLReader());
    ...
    public static class JbossNamespaceFilter extends XMLFilterImpl {

        public JbossNamespaceFilter(final XMLReader xmlReader) {
            super(xmlReader);
        }
